   ...
   return (
      <section ref={section} className={styles.section}>
         ...
         <div className={styles.container}>
            <div
               ref={content}
               className={styles.content + " " + styles.opacity}
            >
               ...
               <p className={styles.text}>
                  21 years old, born in Brazil, currently doing a master's
                  degree in Information Systems at the Polytechnic Institute of
                  Bragança. Before that, studied at the Federal University of
                  Technology - Paraná as a graduate in Computer Science.
               </p>
               <br />
               <p className={styles.text}>
                  I love working on front-end and web development as a whole,
                  solving problems and finding easy and better solutions to
                  appear intuitive and simple. Always try my best to create a
                  good interface with the best user experience. I started this
                  project to learn more about visual designs and improve my
                  skills.
               </p>
            </div>
